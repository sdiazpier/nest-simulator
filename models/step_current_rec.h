...
inline port
step_current_rec::handles_test_event( DataLoggingRequest& dlr,
  rport receptor_type )
{
  if ( receptor_type != 0 )
...
inline port
step_current_rec::send_test_event( Node& target,
  rport receptor_type,
  synindex syn_id,
  bool dummy_target )
{
...
inline void
step_current_rec::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
...
inline void
step_current_rec::set_status( const DictionaryDatum& d )
{
