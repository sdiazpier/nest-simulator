...
#ifndef TERUB_NEURON_GPE
#define TERUB_NEURON_GPE
#include "config.h"
...
extern "C" inline int terub_neuron_gpe_dynamics(double, const double y[],
                                                double f[], void *pnode);
...
terub_neuron_gpe is an implementation of a spiking neuron using the Terman Rubin
model
...
Empty
*/
class terub_neuron_gpe : public nest::Archiving_Node {
public:
  /**
  ...
  */
  terub_neuron_gpe(const terub_neuron_gpe &);
  ...
  */
  ...
  inline double get_E_gg() const { return P_.E_gg; }

  inline void set_E_gg(const double v) { P_.E_gg = v; }
  ...
  inline double get_g_tau_n_0() const { return S_.g_tau_n_0; }
  inline void set_g_tau_n_0(const double v) { S_.g_tau_n_0 = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_tau_n_1() const { return S_.g_tau_n_1; }
  inline void set_g_tau_n_1(const double v) { S_.g_tau_n_1 = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_theta_n_tau() const { return S_.g_theta_n_tau; }
  inline void set_g_theta_n_tau(const double v) { S_.g_theta_n_tau = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_sigma_n_tau() const { return S_.g_sigma_n_tau; }
  inline void set_g_sigma_n_tau(const double v) { S_.g_sigma_n_tau = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_tau_h_0() const { return S_.g_tau_h_0; }
  inline void set_g_tau_h_0(const double v) { S_.g_tau_h_0 = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_tau_h_1() const { return S_.g_tau_h_1; }
  inline void set_g_tau_h_1(const double v) { S_.g_tau_h_1 = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_theta_h_tau() const { return S_.g_theta_h_tau; }
  inline void set_g_theta_h_tau(const double v) { S_.g_theta_h_tau = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_sigma_h_tau() const { return S_.g_sigma_h_tau; }
  inline void set_g_sigma_h_tau(const double v) { S_.g_sigma_h_tau = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_tau_r() const { return S_.g_tau_r; }
  inline void set_g_tau_r(const double v) { S_.g_tau_r = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_theta_a() const { return S_.g_theta_a; }
  inline void set_g_theta_a(const double v) { S_.g_theta_a = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_sigma_a() const { return S_.g_sigma_a; }
  inline void set_g_sigma_a(const double v) { S_.g_sigma_a = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_theta_h() const { return S_.g_theta_h; }
  inline void set_g_theta_h(const double v) { S_.g_theta_h = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_sigma_h() const { return S_.g_sigma_h; }
  inline void set_g_sigma_h(const double v) { S_.g_sigma_h = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_theta_m() const { return S_.g_theta_m; }
  inline void set_g_theta_m(const double v) { S_.g_theta_m = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_sigma_m() const { return S_.g_sigma_m; }
  inline void set_g_sigma_m(const double v) { S_.g_sigma_m = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_theta_n() const { return S_.g_theta_n; }
  inline void set_g_theta_n(const double v) { S_.g_theta_n = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_sigma_n() const { return S_.g_sigma_n; }
  inline void set_g_sigma_n(const double v) { S_.g_sigma_n = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_theta_r() const { return S_.g_theta_r; }
  inline void set_g_theta_r(const double v) { S_.g_theta_r = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_sigma_r() const { return S_.g_sigma_r; }
  inline void set_g_sigma_r(const double v) { S_.g_sigma_r = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_theta_s() const { return S_.g_theta_s; }
  inline void set_g_theta_s(const double v) { S_.g_theta_s = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_sigma_s() const { return S_.g_sigma_s; }
  inline void set_g_sigma_s(const double v) { S_.g_sigma_s = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_phi_h() const { return S_.g_phi_h; }
  inline void set_g_phi_h(const double v) { S_.g_phi_h = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_phi_n() const { return S_.g_phi_n; }
  inline void set_g_phi_n(const double v) { S_.g_phi_n = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_phi_r() const { return S_.g_phi_r; }
  inline void set_g_phi_r(const double v) { S_.g_phi_r = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_epsilon() const { return S_.g_epsilon; }
  inline void set_g_epsilon(const double v) { S_.g_epsilon = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_k_Ca() const { return S_.g_k_Ca; }
  inline void set_g_k_Ca(const double v) { S_.g_k_Ca = v; }

  /* generated by template org.nest.nestml.function.MemberVariableGetterSetter*/

  inline double get_g_k1() const { return S_.g_k1; }
  inline void set_g_k1(const double v) { S_.g_k1 = v; }
...
protected:
  ...
  friend class nest::RecordablesMap<terub_neuron_gpe>;
  friend class nest::UniversalDataLogger<terub_neuron_gpe>;
  ...
  */
  struct Parameters_ {
    ...
    inline double get_E_gg() const { return E_gg; }
    inline void set_E_gg(const double E_gg) { this->E_gg = E_gg; }
  ...
  */
  struct State_ {
    ...
    double g_theta_n_tau; //

    /* generated by template org.nest.nestml.function.MemberDeclaration*/

    double g_sigma_n_tau; //
    ...
    double g_theta_h_tau; //

    /* generated by template org.nest.nestml.function.MemberDeclaration*/

    double g_sigma_h_tau; //
  ...
  */
   ...
   * that
    ...
    */
  struct Buffers_ {
    Buffers_(terub_neuron_gpe &);
    Buffers_(const Buffers_ &, terub_neuron_gpe &);
    ...
    nest::UniversalDataLogger<terub_neuron_gpe> logger_;
...
private:
  ...
  */
  ...
  static nest::RecordablesMap<terub_neuron_gpe> recordablesMap_;

  friend int terub_neuron_gpe_dynamics(double, const double y[], double f[],
                                       void *pnode);
  /** @} */
}; /* neuron terub_neuron_gpe */

inline nest::port terub_neuron_gpe::send_test_event(nest::Node &target,
...
inline nest::port
terub_neuron_gpe::handles_test_event(nest::SpikeEvent &,
...
inline nest::port
terub_neuron_gpe::handles_test_event(nest::CurrentEvent &,
                                     nest::port receptor_type) {
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
terub_neuron_gpe::handles_test_event(nest::DataLoggingRequest &dlr,
                                     nest::port receptor_type) {
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void terub_neuron_gpe::get_status(DictionaryDatum &__d) const {
...
inline void terub_neuron_gpe::set_status(const DictionaryDatum &__d) {
  ...
  double tmp_E_gg;
  if (updateValue<double>(__d, "E_gg", tmp_E_gg)) {
    set_E_gg(tmp_E_gg);
  }
