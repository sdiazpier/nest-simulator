...
* Recordables map
* ---------------------------------------------------------------- */
nest::RecordablesMap<terub_neuron_gpe> terub_neuron_gpe::recordablesMap_;

namespace nest {
// Override the create() method with one call to RecordablesMap::insert_()
// for each quantity to be recorded.
template <> void RecordablesMap<terub_neuron_gpe>::create() {
  // use standard names whereever you can for consistency!
  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("V_m", &terub_neuron_gpe::get_V_m);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("g_in", &terub_neuron_gpe::get_g_in);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("g_ex", &terub_neuron_gpe::get_g_ex);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("gate_h", &terub_neuron_gpe::get_gate_h);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("gate_n", &terub_neuron_gpe::get_gate_n);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("gate_r", &terub_neuron_gpe::get_gate_r);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("Ca_con", &terub_neuron_gpe::get_Ca_con);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("g_ex'", &terub_neuron_gpe::get___D_g_ex);

  /* generated by template org.nest.nestml.function.RecordCallback*/

  insert_("g_in'", &terub_neuron_gpe::get___D_g_in);
  ...
  // ignores the E_gg with the domain type double
  ...
  // ignores the g_tau_n_0 with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_tau_n_1 with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_theta_n_tau with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_sigma_n_tau with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_tau_h_0 with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_tau_h_1 with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_theta_h_tau with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_sigma_h_tau with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_tau_r with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_theta_a with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_sigma_a with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_theta_h with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_sigma_h with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_theta_m with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_sigma_m with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_theta_n with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_sigma_n with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_theta_r with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_sigma_r with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_theta_s with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_sigma_s with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_phi_h with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_phi_n with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_phi_r with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_epsilon with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_k_Ca with the domain type double

  /* generated by template org.nest.nestml.function.RecordCallback*/

  // ignores the g_k1 with the domain type double
...
terub_neuron_gpe::Parameters_::Parameters_() {}

terub_neuron_gpe::State_::State_() {}

/* ----------------------------------------------------------------
* Parameter and state extractions and manipulation functions
* ---------------------------------------------------------------- */

void terub_neuron_gpe::Parameters_::set(const DictionaryDatum &__d) {}

void terub_neuron_gpe::State_::set(const DictionaryDatum &__d,
                                   const Parameters_ &p) {}

terub_neuron_gpe::Buffers_::Buffers_(terub_neuron_gpe &n)
    : logger_(n), s_(0), c_(0), e_(0) {}

terub_neuron_gpe::Buffers_::Buffers_(const Buffers_ &, terub_neuron_gpe &n)
    : logger_(n), s_(0), c_(0), e_(0) {}
...
terub_neuron_gpe::terub_neuron_gpe() : Archiving_Node(), P_(), S_(), B_(*this) {
...
terub_neuron_gpe::terub_neuron_gpe(const terub_neuron_gpe &n)
...
terub_neuron_gpe::~terub_neuron_gpe() {
...
void terub_neuron_gpe::init_state_(const Node &proto) { // TODO inner components

  const terub_neuron_gpe &pr = downcast<terub_neuron_gpe>(proto);
  S_ = pr.S_;
}
...
extern "C" inline int terub_neuron_gpe_dynamics(double, const double y[],
                                                double f[], void *pnode) {
  typedef terub_neuron_gpe::State_ State_;
  // get access to node so we can almost work as in a member function
  assert(pnode);
  const terub_neuron_gpe &node = *(reinterpret_cast<terub_neuron_gpe *>(pnode));

  // y[] here is---and must be---the state vector supplied by the integrator,
  // not the state vector in the node, node.S_.y[].

  double g_tau_n_0 = 0.05;
  double g_tau_n_1 = 0.27;
  double g_theta_n_tau = ((-40.0));
  double g_sigma_n_tau = ((-12.0));
  double g_tau_h_0 = 0.05;
  double g_tau_h_1 = 0.27;
  double g_theta_h_tau = ((-40.0));
  double g_sigma_h_tau = ((-12.0));
  double g_tau_r = 30.0;
  double g_theta_a = ((-57.0));
  double g_sigma_a = 2.0;
  double g_theta_h = ((-58.0));
  double g_sigma_h = ((-12.0));
  double g_theta_m = ((-37.0));
  double g_sigma_m = 10.0;
  double g_theta_n = ((-50.0));
  double g_sigma_n = 14.0;
  double g_theta_r = ((-70.0));
  double g_sigma_r = ((-2.0));
  double g_theta_s = ((-35.0));
  double g_sigma_s = 2.0;
  double g_phi_h = 0.05;
  double g_phi_n = 0.1; // or 0.05;
  double g_phi_r = 1.0;
  double g_epsilon = 0.0001;
  double g_k_Ca = 15.0; // or 20.0;
  double g_k1 = 30.0;
  double I_ex_mod = ((-y[State_::g_ex])) * y[State_::V_m];
  double I_in_mod = y[State_::g_in] * (y[State_::V_m] - node.get_E_gg());
  double tau_n =
      g_tau_n_0 +
      g_tau_n_1 / (1. + std::exp(((-(y[State_::V_m] - g_theta_n_tau))) /
                                 g_sigma_n_tau));
  double tau_h =
      g_tau_h_0 +
      g_tau_h_1 / (1. + std::exp(((-(y[State_::V_m] - g_theta_h_tau))) /
                                 g_sigma_h_tau));
  double tau_r = g_tau_r;
  double a_inf =
      1. / (1. + std::exp(((-(y[State_::V_m] - g_theta_a))) / g_sigma_a));
  double h_inf =
      1. / (1. + std::exp(((-(y[State_::V_m] - g_theta_h))) / g_sigma_h));
  double m_inf =
      1. / (1. + std::exp(((-(y[State_::V_m] - g_theta_m))) / g_sigma_m));
  double n_inf =
      1. / (1. + std::exp(((-(y[State_::V_m] - g_theta_n))) / g_sigma_n));
  double r_inf =
      1. / (1. + std::exp(((-(y[State_::V_m] - g_theta_r))) / g_sigma_r));
  double s_inf =
      1. / (1. + std::exp(((-(y[State_::V_m] - g_theta_s))) / g_sigma_s));
  ...
  f[State_::gate_h] = g_phi_h * ((h_inf - y[State_::gate_h]) / tau_h);
  f[State_::gate_n] = g_phi_n * ((n_inf - y[State_::gate_n]) / tau_n);
  f[State_::gate_r] = g_phi_r * ((r_inf - y[State_::gate_r]) / tau_r);
  f[State_::Ca_con] =
      g_epsilon * (((-I_Ca)) - I_T - g_k_Ca * y[State_::Ca_con]);
...
void terub_neuron_gpe::init_buffers_() {
  ...
  B_.sys_.function = terub_neuron_gpe_dynamics;
  B_.sys_.jacobian = NULL;
  B_.sys_.dimension = 9;
  B_.sys_.params = reinterpret_cast<void *>(this);
}

void terub_neuron_gpe::calibrate() {
  B_.logger_.init();
 ...
 */
void terub_neuron_gpe::update(nest::Time const &origin, const long from,
                              const long to) {
...
void terub_neuron_gpe::handle(nest::DataLoggingRequest &e) {
  B_.logger_.handle(e);
}

void terub_neuron_gpe::handle(nest::SpikeEvent &e) {
...
void terub_neuron_gpe::handle(nest::CurrentEvent &e) {
  assert(e.get_delay() > 0);
