...
const Name deletion_threshold( "deletion_threshold" );
const Name deletion_threshold_sigma( "deletion_threshold_sigma" );
...
const Name linear_deletion( "linear_deletion" );
...
const Name random_vacant( "random_vacant" );
...
const Name sigmoidal_deletion( "sigmoidal_deletion" );
